...
const Unauthorized = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-fit gap-12 py-8 ">
      <svg
      ...
      <div className="flex flex-col justify-center items-center gap-2 sm:gap-4 w-full">
        <h1 className="text-lg sm:text-3xl font-medium text-center">
